...
redPlayer = gup("player1")//prompt("What is the name of the red player?", "")
blackPlayer = gup("player2")//prompt("What is the name of the black player?", "")
...
creatediv('winner_div', winner +' is the winner', 160, 25, 380, 384)
